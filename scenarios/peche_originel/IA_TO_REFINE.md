# Mystère : Péché Originel

> **Contexte** : One-shot préhistorique — variante *Lance d'Os* (MotW).
...
> [!IMPORTANT]
> Le pivot dramatique de ce scénario n'est **pas de tuer le monstre** mais de **réparer le méfait**.
> Magog n'est pas un ennemi à abattre : c'est l'Esprit de la Forêt blessé et corrompu.
> La "victoire" passe par la restitution, le sacrifice ou le rachat de Gog.
> Le Compte à Rebours ci-dessous avance donc vers **la corruption irréversible**, pas vers une apocalypse violente.

---

## 1. La Menace Principale — Magog, l'Esprit Corrompu

*Phénomène : **Sortilège (Hex)*** — motivation : corrompre et faire pourrir l'environnement.

*   **Nom** : Magog (autrefois l'Esprit de la Forêt, sans nom car innommable)
*   **Type & Motivation** : Phénomène — *Sortilège* — corrompre et faire pourrir la vallée depuis l'intérieur
*   **Nature** : Ce n'est pas une créature autonome. C'est une **blessure dans le tissu du monde**, née de la transgression de Gog. Magog se manifeste comme une présence de ténèbres végétales : arbres qui saignent une sève noire, animaux aux yeux vides, visions cauchemardesques.
*   **Pouvoirs & Capacités** :
    * *Corruption du vivant* : tout animal ou plante à proximité de la Forêt Sacrée peut devenir un vecteur de Magog (yeux noirs, comportement aberrant).
    * *Hantise des rêves* : les membres de la tribu qui dorment près de la forêt reçoivent des visions de la transgression de Gog — accusatrices, terrifiantes.
    * *Voix de Gog* : Magog peut parler par la bouche de Gog, corrompu de l'intérieur, pour attirer d'autres membres vers la forêt.
...
*   **Santé (Harm)** : Magog ne peut pas être blessé physiquement. Toute attaque directe contre la Forêt renforce la corruption.
*   **Attaque de base** : *Envoi de visions* (1 harm, ignore armure, psychologique — le PJ doit agir sous l'emprise ou perdre le contrôle de son personnage un instant).
...
*   **Rok, le Chef de Chasse** *(Officiel — être méfiant)* : Il voudrait partir à la guerre contre la forêt. Il ne croit pas au rituel. Il risque de provoquer une catastrophe en attaquant la lisière avec des chasseurs.

*   **Mira** *(Innocent — survivre)* : Petite sœur de Gog. Elle a vu Gog partir vers la forêt cette nuit-là mais s'est tue par peur. Elle est la clé de l'accroche émotionnelle.
...
- Brin, l'apprenti flûtiste
- Yma, la tisserande des peaux
...
### La Pierre de Magog — Scène obligatoire

Avant de pouvoir accomplir le rituel de réparation, les PJ doivent **trouver et extraire la pierre**. Elle ne peut pas être taillée dans du silex ou ramassée dans un lit de rivière — elle doit venir de *l'intérieur* de la corruption.

**Comment la pierre apparaît :**
Une bête de la vallée a été corrompue par Magog — un grand ours ou un auroch, animal totémique de la tribu. On le retrouve errant, les yeux noirs, la gueule écumante de sève sombre, incapable de mourir bien qu'il soit visiblement blessé depuis l'intérieur. Sous sa fourrure, là où devrait battre son cœur, quelque chose *pulse* — dur, noir, brûlant.

**La scène en trois temps :**

1. 🐻 **Confronter la bête** — Ne pas la tuer par violence pure. La tuer « proprement » (rituel de chasse, demande de permission à son esprit) est la seule façon d'approcher sans que la pierre ne rejette les PJ. Rok voudra l'abattre à la lance. C'est faux.
2. 🖤 **Extraire la pierre** — Plonger les mains dans le corps encore chaud. La pierre est là, noire comme de la nuit solidifiée, à peine plus grande qu'un poing, brillante d'une façon qui n'est pas de la lumière. Elle *brûle* celui qui la touche sans protection spirituelle. Le Spirite doit la saisir en transe, ou L'Autre en protégeant son esprit d'une autre façon.
3. 🔥 **La pierre crie** — Quand on la sort, elle émet un son — pas un son d'animal, un son *de forêt*. Les arbres alentour frémissent. Magog sait. Le Compte à Rebours avance d'un cran si les PJ ne bougent pas immédiatement.

**Ce que la Gardienne du Feu en fait :**
...
- S'il reste intact après → il devient le totem fondateur de la tribu, portant la mémoire de Gog
...
|---|---|---|
| **Réparation** | Gog avoue, sacrifice volontaire (son sang ou sa mémoire des fruits), rituel accompli | L'Esprit est apaisé, la forêt recule. Gog survit mais a oublié quelque chose d'essentiel. |
| **Sacrifice total** | Gog offre sa vie volontairement | La forêt est purifiée. La tribu pleure un héros. Le médaillon devient un objet sacré. |
| **Échec partiel** | Rituel incomplet, Rok attaque la forêt | Magog est contenu mais non guéri. La tribu doit vivre avec une cicatrice. |
| **Minuit** | Les PJ n'agissent pas | La vallée est perdue. Point de départ d'une campagne sur la diaspora de la tribu. |

---

## Références d'Ambiance

- 🎬 *Ao, le dernier Néandertal* (2010) — esthétique préhistorique douce et mystique
- 🎬 *La Guerre du Feu* (1981) — immersion tribale, langage du corps
- 🎬 *Princess Mononoke* (Miyazaki) — esprit de la forêt blessé, réparation plutôt que destruction
- 📖 *Genèse* — structure du péché originel, l'interdit, la chute, le méfait
- 🎵 Musique : tambours chamaniques, flûtes en os, silence — *Dead Can Dance, "Toward the Within"*
